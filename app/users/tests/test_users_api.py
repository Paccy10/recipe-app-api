...
class PublicUsersAPITests(TestCase):
    ...
    def test_create_token_with_invalid_credentials(self):
        ...
        create_user(email='test@recipeapp.com', password='password')
        payload = {'email': 'test@recipeapp.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_without_user(self):
        ...
        payload = {'email': 'test@recipeapp.com', 'password': 'password'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        payload = {'email': 'test@recipeapp.com', 'password': ''}
        res = self.client.post(TOKEN_URL, payload)
...
class PrivateUsersAPITests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(
            email='test@recipeapp.com', password='testpass', name='test')
